import AKAW19ActualFamilyNativeMoments
...
/-- Actual original higher-vanishing data supply the SAME corrected Cartesian
field with joint integer-cell L2 and both frequency moments, at original width. -/
theorem actualCartesianSource_nativeCellMoments
  ...
  exact actualCartesianFamily_nativeCellMoments parameters length compact lengthPositive widthHalf widthLength state small source flat
