import AKAY28GenuineLocalizedResolvent
...
theorem actualOriginalB10GenuinePrincipalResolventSmall (parameters : PhaseParameters)
  ...
  obtain ⟨lowRadius, lowPositive, lowOne, supplied⟩ := actualOriginalB10GenuineSmallRows parameters L radius primitiveThreshold
  ...
  obtain ⟨ledger, primitiveMargin, inverseCoherent, reduction, small⟩ := supplied
