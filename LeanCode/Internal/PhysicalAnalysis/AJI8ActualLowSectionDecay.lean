import AJI7ActualLowContinuousBounds
...
theorem actualLowPhysicalSection_decay (parameters : PhaseParameters)
  ...
  have raw := actualLowPhysicalSection_bound lower length positive bounded parameters field index radius
