...
/-- Reuse the actual ledger and accepted row bounds while retaining the
 same gauge estimate needed by the rough native Qa recovery. -/
theorem actualOriginalB10NativeGaugeRows (parameters : PhaseParameters)
        ...
        ∀ base : ACore parameters 3,
          ...
          ∃ ledger : ActualLedger parameters admissible rho alpha delta parameter epsilon base,
            ...
            ∃ inverseCoherent : FamilyCoherent (determinantInverseFamily admissible ledger.val.gaugeDeviation),
              ...
              ActualGenuineStartupRowsSmall ledger inverseCoherent operatorThreshold ∧
  ...
  exact ⟨ledger, primitiveMargin, inverseCoherent, actualLedgerReduction_of_projection ledger inverseCoherent laws,
    rowsSmall,four,fourNonnegative,unitSmall,gaugeBound,determinantSmall⟩
