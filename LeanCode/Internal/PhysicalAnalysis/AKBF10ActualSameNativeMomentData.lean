...
theorem actualCartesianFamily_originalNativeMoments :
    Nonempty (OriginalNativeMoments parameters
  ...
  obtain ⟨_,_,covariant,covariantMoments,covariantZero,covariantSame,covariantGraded,_⟩ :=
    actualCartesianCovariant_nativeCellMoments parameters length compact lengthPositive widthHalf widthLength state small
      source flat fields member sameSources allGrades compatible vanishing graded sameGrade constants estimate
  obtain ⟨_,_,xi,xiMoments,xiZero,xiSame,xiGraded,_⟩ :=
    actualCartesianXiOverRadius_nativeCellMoments parameters length compact lengthPositive widthHalf widthLength state small
      source flat fields member sameSources allGrades compatible vanishing graded sameGrade constants estimate
  exact ⟨⟨⟨covariant,covariantMoments,covariantZero,covariantGraded⟩,
    ⟨xi,xiMoments,xiZero,xiGraded⟩,covariantSame,xiSame⟩⟩
