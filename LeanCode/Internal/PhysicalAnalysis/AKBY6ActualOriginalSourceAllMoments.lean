...
startup moments at every natural power, with the same original analytic width. -/
theorem actualCartesianSource_startupNativeAllMoments
    ...
    (allGrades : ∀ index grade : ℕ, ∃ weighted : CoupledSpace (originalExhaustionRadius length index) length
      ...
      Nonempty (Grad.CartesianStartup.OriginalNativeAllMoments parameters
  ...
  exact actualCartesianFamily_originalNativeAllMoments parameters length compact lengthPositive widthHalf widthLength state small source flat
