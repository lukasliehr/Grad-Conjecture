...
import AKDV28FixedBase32EndpointPayment
...
The planar estimate retains its independent source base32; no comparison
of F32 to F20 is used. -/
theorem finiteJetCore_oneHigh_of_planar_ge_two_base32 (parameters : PhaseParameters)
    (shift loss : ℕ) (lossLarge : shift+32≤loss)
  ...
  have endpointPaid := finiteJetEndpoint_oneHigh_payment32 parameters rank shift loss lossLarge
