...
native/pure-cell twenty-loss bounds, and complete U/S recovery together. -/
theorem actualFiniteJet_fullRecovery_cellTwenty
  ...
  refine ⟨family,?_,?_,covariant,vector,xi,scalar,covariantCells,covariantSame,xiSame,scalarSame,vectorSame,recovery,?_⟩
  · intro index grade
